...
# reverse 
	...
	def volt_sweep(self, startV=0, stopV=1.5, stepV=50, compliance=5, delay=10.0e-2):
		...
		return data
		# pass
# self, startV, stopV, stepV, compliance, delay=10.0e-3, backward=False
	# def dev_jv(self, vmin = -0.1, vmax = 1.2, steps = 50):
		# self.keithley.shutdown()
		# time.sleep(0.1)
		# self._source_voltage_measure_current()
		# time.sleep(0.1)
		# self.keithley.source_voltage = vmin
		# self.keithley.volt_sweep(self, startV=0, stopV=1, stepV=50, compliance=2, delay=10e-3)
		# self.keithley.shutdown()
		# print(self.keithley.voltage)


	def fwdrev_jv(self, name, vmin = -0.1, vmax = 1.2, steps = 50, preview = True):
		# reverse 
			self._source_voltage_measure_current()
			self.keithley.source_voltage = vmax
			# self._set_buffer(npts = steps)
